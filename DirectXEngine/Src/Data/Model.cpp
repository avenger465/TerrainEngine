...
void Model::ResizeModel(std::vector<std::vector<float>>& temp, int resolution, CVector3 MinX, CVector3 MaxX)
{
	mMesh->UpdateVertices(MinX, MaxX, resolution, resolution, temp, true, true);
}
