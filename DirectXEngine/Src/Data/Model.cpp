...
void Model::ResizeModel(std::vector<std::vector<float>>& temp, float* temp1, int resolution, CVector3 MinX, CVector3 MaxX)
{
	mMesh->UpdateVertices(MinX, MaxX, resolution, resolution, temp1, temp, true, true);
}
